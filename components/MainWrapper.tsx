                                          ...
                                          {selected ? (
                                            <span
                                              className={classNames(
                                                active ? 'text-white bg-gray-900' : 'text-gray-900',
                          ...
                          <Disclosure as="div">
                            {({ open }) => (
                              <>
                                <Disclosure.Button
                                  className={classNames(
                                    item.current ? 'bg-gray-50' : 'hover:bg-gray-100 hover:text-gray-900',
                                  ...
                                  {item.children.map((subItem) => (
                                    <li key={subItem.name}>
                                      ...
                                      <Disclosure.Button
                                        ...
                                        href={subItem.href}
                                        className={classNames(
                                          subItem.current ? 'bg-gray-50' : 'hover:bg-gray-100 hover:text-gray-900',
